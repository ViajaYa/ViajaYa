...
const UserManagment = () => {
  ...
  useEffect(() => {
    // Cargar líderes y gerentes solo una vez
    dispatch(fetchUsersByRole(3)).then(res => setLeaders(res.payload || []));
    dispatch(fetchUsersByRole(4)).then(res => setManagers(res.payload || []));
  }, [dispatch]);
