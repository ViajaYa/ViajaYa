    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-sm border p-8 text-center max-w-md w-full">
        ...
        <p className="text-gray-600 mb-6">
          Los datos de todos los pasajeros han sido guardados exitosamente. 
          Nos pondremos en contacto con usted para continuar con el proceso de reserva.
        </p>
...
export default PassengerSuccess;