...
const CommissionsList = () => {
    ...
    const loadCommissions = () => {
        ...
        const cleanFilters = Object.fromEntries(
            Object.entries(filters).filter(([_, value]) => value && value !== 'all' && value !== '')
        );
    ...
    const stats = {
        ...
        totalAmount: commissions.reduce((sum, c) => sum + parseFloat(c.monto_comision || 0), 0),
            ...
            <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                            <div>
                                ...
                                >
                                    ...
                                    <option value="generated">Activas (primer pago recibido)</option>
                                    <option value="approved">Aprobadas (listas para pagar)</option>
                ...
                <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
                    ...
                    <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-yellow-600 text-sm font-medium">Sin Documento</p>
                                <p className="text-xl font-bold text-yellow-900">{stats.generatedWithoutDoc}</p>
                    ...
                    <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-blue-600 text-sm font-medium">Para Aprobar</p>
                                <p className="text-xl font-bold text-blue-900">{stats.generatedWithDoc}</p>
                    ...
                    <div className="bg-purple-50 p-4 rounded-lg border border-purple-200">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-purple-600 text-sm font-medium">Para Pagar</p>
                                <p className="text-xl font-bold text-purple-900">{stats.approved}</p>
                    ...
                    <div className="bg-green-50 p-4 rounded-lg border border-green-200">
                        <div className="flex items-center justify-between">
                            ...
                            <FontAwesomeIcon icon={faCreditCard} className="text-green-500 text-xl" />
                        </div>
                    </div>
                    ...
                    <div className="bg-indigo-50 p-4 rounded-lg border border-indigo-200">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-indigo-600 text-sm font-medium">Total Monto</p>
                                <p className="text-lg font-bold text-indigo-900">
                                    {formatCurrency(stats.totalAmount)}
                                </p>
                            </div>
                            <FontAwesomeIcon icon={faDollarSign} className="text-indigo-500 text-xl" />
                        </div>
                    </div>
                </div>
                                ...
                                {commissions.length === 0 ? (
                                    <tr>
                                        <td colSpan="7" className="px-6 py-12 text-center">
                                            ...
                                            <p className="text-gray-500">No hay comisiones que coincidan con los filtros</p>
                                        ...
                                        <tr key={commission.id} className={getCommissionRowColor(commission)}>
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap">
                                                <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium border ${getStatusColor(commission.status, !!commission.DocumentoSoporte)}`}>
                                                    <FontAwesomeIcon
                                                        icon={getStatusIcon(commission.status, !!commission.DocumentoSoporte)}
                                                        className="mr-1"
                                                    />
