...
import { putPopup, getPopup } from '../../redux/actions/actions';
...
const Popup = ({ id }) => {
  ...
  useEffect(() => {
    if (id) {
      dispatch(getPopup(id)); // Llama a la acción para obtener el popup
    }
  }, [dispatch, id]);
  ...
  return (
    <div className="fixed inset-0 bg-gray-800 bg-opacity-70 flex justify-center items-center z-50">
      <div className="relative bg-ColorAzul bg-opacity-80 text-gray-600 p-6 sm:p-8 rounded-lg shadow-lg w-11/12 sm:w-3/4 md:w-2/3 lg:w-1/2 max-w-xs sm:max-w-md md:max-w-2xl h-auto max-h-[80%] overflow-y-auto mx-auto">
